...
//	static final String MESSAGEFILE = "C:\\Users\\TUNGPV\\Pictures\\message.txt";
	static final String COVERIMAGEFILE = ".\\pictures\\root\\cover1.jpg";
	static final String STEGIMAGEFILE = ".\\pictures\\root\\steg.png";
...
//	}
	...
	public  void EnCode(String scretMessage) throws Exception {
		int[] bits = bit_Msg(scretMessage);
		System.out.println("msg in file " + scretMessage);
		for (int i = 0; i < bits.length; i++)
			System.out.print(bits[i]);
		System.out.println();
		BufferedImage theImage = readImageFile(COVERIMAGEFILE);
...
//	}
	...
	public BufferedImage readImageFile(String coverFile) {
		BufferedImage theImage = null;
		File p = new File(coverFile);
		try {
